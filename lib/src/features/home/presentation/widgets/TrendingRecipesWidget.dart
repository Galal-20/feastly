...
class RecipesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) {
      ...
      return bloc;
    }, child: BlocBuilder<TrendingRecipesBloc, TrendingRecipesState>(
                    ...
                    return InkWell(
                      onTap: () {
                        GoRouter.of(context).push(AppRoutes.kFoodDetailsScreen,
                            extra: trendingRecipesList[index]);
                      },
                      child: RecipeCard(
                          name: trendingRecipesList[index].foodTitle,
                          noOfIngredients: trendingRecipesList[index]
                              .numberOfIngredients
                              ,
                          time:
                              trendingRecipesList[index].cookingTime,
                        child: Image.network(
